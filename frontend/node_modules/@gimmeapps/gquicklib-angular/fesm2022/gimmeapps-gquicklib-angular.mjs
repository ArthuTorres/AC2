...
import { Injectable, NgModule, Component, Input, EventEmitter, Output, ViewChild } from '@angular/core';
import * as i1$1 from '@angular/common';
import { CommonModule } from '@angular/common';
import { FlexLayoutModule } from '@angular/flex-layout';
import { HttpParams } from '@angular/common/http';
import { faHome, faBars, faTag, faListCheck, faWrench, faCircleUser, faRightFromBracket, faAdd, faPencil, faTrash, faSearch, faCaretLeft, faCaretRight, faClose, faXmark } from '@fortawesome/free-solid-svg-icons';
...
class SharedModule {
    ...
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.0", ngImport: i0, type: SharedModule, imports: [CommonModule,
...
class BaseComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "17.3.0", type: BaseComponent, selector: "quick-base-component", inputs: { color: "color", componentStyle: "componentStyle", componentSize: "componentSize", round: "round", stretch: "stretch", disabled: "disabled" }, ngImport: i0, template: '', isInline: true }); }
}
...
class UiModule {
    ...
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.0", ngImport: i0, type: UiModule, declarations: [ColumnComponent,
            RowComponent,
            ToolbarComponent,
            DatagridComponent], imports: [CommonModule,
            SharedModule,
            ButtonModule], exports: [IconModule,
            ButtonModule,
            CardModule,
            ColumnComponent,
            RowComponent,
...
class FormFieldComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "17.3.0", type: FormFieldComponent, selector: "quick-form-field", ngImport: i0, template: "<ng-content select=\"label\"></ng-content>\n<ng-content select=\"input, textarea, select\"></ng-content>\n<ng-content select=\"quick-form-autocomplete\"></ng-content>\n<div class=\"info\">\n    <ng-content select=\"quick-form-error\"></ng-content>\n</div>", styles: [":host{box-sizing:border-box;display:flex;flex-direction:column;flex:1;margin-bottom:.3rem}.info{position:relative;overflow:hidden;height:1.2rem}::ng-deep label{margin-bottom:.5rem;font-weight:500;color:var(--gray-700);transition:all .15s ease-in-out}::ng-deep input:not([type=checkbox]),::ng-deep select,::ng-deep textarea{box-sizing:border-box;display:block;min-width:240px;width:100%;padding:.75rem;font-weight:500;color:var(--gray-700);appearance:none;background-color:var(--body-bg);background-clip:padding-box;border:1px solid var(--gray-300);border-radius:.5rem;box-shadow:false;transition:all .15s ease-in-out}::ng-deep input:not([type=checkbox]):focus,::ng-deep select:focus,::ng-deep textarea:focus{color:var(--gray-700);background-color:var(--body-bg);border-color:var(--gray-400);outline:0}::ng-deep input:not([type=checkbox]):disabled,::ng-deep select:disabled,::ng-deep textarea:disabled{opacity:.6}::ng-deep textarea{resize:none}\n"] }); }
}
...
export { AuthModule, ButtonComponent, ButtonModule, CardBodyComponent, CardComponent, CardHeaderComponent, CardModule, CardTitleComponent, ColumnComponent, DatagridComponent, FileManagerModule, FilterBuilder, FormAutocompleteComponent, FormErrorComponent, FormFieldComponent, IconComponent, IconModule, ModalsModule, PhotoGaleryComponent, QuickFormsModule, RestService, RowComponent, ShadowboxComponent, SharedModule, ToolbarComponent, UiModule };
